...
namespace FinanceManager.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        public ExpensesController(AppDBContent context, IUriService uriService)
        {
            _context = context;
        ...
        public async Task<ActionResult<IEnumerable<Expense>>> GetExpenses([FromQuery] PaginationFilter filter, string searchstr, decimal? priceLow, decimal? priceHigh, DateTime? minDate, DateTime? maxDate)
        {
            ...
            PagedResponse<IEnumerable<Expense>> pagedResponse = PaginationHelper.CreatePagedReponse<Expense>(expensesList, filter, totalRecords, uriService, route);
